...
import sinnake.auth.spring.entity.User;
...
public class SinnakeUserDetailService extends JdbcDaoImpl {
	 ...
	 */
	@Autowired
	public SinnakeUserDetailService(DataSource dataSource
		, @Value("#{serverProp['sqlUsersByUsernameQuery']}") String sqlUsersByUsernameQuery
		, @Value("#{serverProp['sqlAuthoritiesByUsernameQuery']}") String sqlAuthoritiesByUsernameQuery) throws Exception {
