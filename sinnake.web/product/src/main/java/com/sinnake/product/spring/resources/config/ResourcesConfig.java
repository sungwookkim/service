package com.sinnake.product.spring.resources.config;
...
import com.sinnake.product.prop.resourcesConfig.ProductResourcesConfig;
...
public class ResourcesConfig extends ResourceServerConfigurerAdapter {
	...
	public void configure(HttpSecurity http) throws Exception {
		...
		new ProductResourcesConfig().configure(http);
	}
