package com.sinnake.member.jpa;
 ...
 */
@Configuration
@Component("memberJpaConfig")
public class JpaConfig {

	private DataSource memberDataSource;

	@Autowired
	public JpaConfig(DataSource memberDataSource) {
	 ...
	 */
	@Bean("memberPersistenceExceptionTranslationPostProcessor")
