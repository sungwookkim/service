package com.sinnake.product.db.type;
...
public class MysqlConfig implements DbConfigInterface {
	 ...
	 */
	@Autowired
	public MysqlConfig(@Value("#{productDbProp['product.db.mysql.username']}") String userName
		, @Value("#{productDbProp['product.db.mysql.url']}") String url
		, @Value("#{productDbProp['product.db.mysql.password']}") String password
		, @Value("#{productServerProp['product.dbAes256.key']}") String dbKey) {
